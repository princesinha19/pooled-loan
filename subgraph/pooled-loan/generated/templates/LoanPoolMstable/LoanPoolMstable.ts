...
export class LoanPoolMstable extends ethereum.SmartContract {
  static bind(address: Address): LoanPoolMstable {
    return new LoanPoolMstable("LoanPoolMstable", address);
  }
